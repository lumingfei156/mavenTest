...
//            CellRangeAddress callRangeAddress22 = new CellRangeAddress(2,2,5,7);//起始行,结束行,起始列,结束列
            ...
            CellRangeAddress callRangeAddress34 = new CellRangeAddress(1,1,3,5);//起始行,结束行,起始列,结束列
            CellRangeAddress callRangeAddress35 = new CellRangeAddress(1,1,6,8);//起始行,结束行,起始列,结束列
//            CellRangeAddress callRangeAddress36 = new CellRangeAddress(1,2,6,6);//起始行,结束行,起始列,结束列
//            CellRangeAddress callRangeAddress37 = new CellRangeAddress(1,2,7,7);//起始行,结束行,起始列,结束列
...
//            cell.setCellValue("xxxx项目部");
            ...
            String[] titles = {"序号","工作内容","用工总人数","工日数","单价（元）","单价（元）","单价（元）"};//""为占位字符串
            ...
            String[] titlefour = {"普工用工数","技工用工数","fuck1","fuck2"};
